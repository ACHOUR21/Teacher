import { PrismaClient, UserRole, TenantType, SubscriptionPlan, SubscriptionStatus, CourseLevel, ContentType, } from '@prisma/client';
...
async function main() {
    ...
    for (const { tenant, specs } of allTenantCourses) {
        ...
        const primaryTeacherId = teachers.length > 0
