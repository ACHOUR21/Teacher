...
describe('AnalyticsService', () => {
  ...
  beforeEach(async () => {
    const module = await _testing.Test.createTestingModule({
      providers: [_analytics.AnalyticsService, {
    ...
    service = module.get(_analytics.AnalyticsService);
    jest.clearAllMocks();
  });
  ...
  describe('getStudentActivity', () => {
    it('should return active students, completions, and submissions', async () => {
      mockPrisma.courseProgress.count.mockResolvedValueOnce(80).mockResolvedValueOnce(15);
