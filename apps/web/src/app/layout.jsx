...
export const metadata = {
    ...
    description: 'The complete AI-powered education SaaS platform for schools, universities, and tutoring services. Intelligent tutoring, live classrooms, course management, and more.',
    keywords: [
        'education platform',
        'AI tutor',
        'LMS',
    ...
    metadataBase: new URL(process.env.NEXT_PUBLIC_APP_URL || 'https://app.eduai.io'),
    openGraph: {
        type: 'website',
        locale: 'en_US',
        url: '/',
