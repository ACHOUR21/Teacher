    ...
    return (<div className="min-h-screen bg-white">
      ...
      <section id="features" className="px-6 py-20 bg-gray-50">
        <div className="max-w-6xl mx-auto">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
            {FEATURES.map(f => (<div key={f.title} className="bg-white rounded-xl p-6 border border-gray-200 hover:shadow-md transition-shadow">
      ...
      <section className="px-6 py-16 max-w-4xl mx-auto">
        <div className="grid grid-cols-2 md:grid-cols-4 gap-8 text-center">
          {[['10M+', 'Students worldwide'], ['50K+', 'Courses published'], ['99.9%', 'Uptime SLA'], ['24/7', 'AI tutoring']].map(([stat, label]) => (<div key={label}>
      ...
      <section id="pricing" className="px-6 py-20 bg-gray-50">
        <div className="max-w-5xl mx-auto">
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
            {PLANS.map(plan => (<div key={plan.name} className={`bg-white rounded-2xl p-8 border-2 ${plan.featured ? 'border-blue-500 shadow-lg' : 'border-gray-200'}`}>
                ...
                <ul className="space-y-3 mb-8">
                  {plan.features.map(f => (<li key={f} className="text-sm text-gray-600 flex items-center gap-2">
