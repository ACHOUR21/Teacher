...
export default function JoinPage() {
  ...
  useEffect(() => {
    apiGet<TenantInfo>(`/auth/tenant/lookup?slug=${encodeURIComponent(slug)}`)
      .then(setTenant)
    ...
    <div className="animate-in">
      ...
      <form onSubmit={handleSubmit(onSubmit)} className="space-y-4" noValidate>
        ...
        <div className="grid grid-cols-2 gap-3">
          <div>
            ...
            <div className="relative">
              ...
              <input
                ...
                placeholder="Jane"
                className={cn(
                  'flex h-10 w-full rounded-md border bg-background px-3 py-2 pl-9 text-sm focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-ring transition-colors',
          ...
          <div>
            ...
            <input
              ...
              placeholder="Doe"
              className={cn(
                'flex h-10 w-full rounded-md border bg-background px-3 py-2 text-sm focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-ring transition-colors',
        ...
        <button
          type="submit"
          disabled={isLoading}
          className="w-full flex items-center justify-center gap-2 h-10 bg-primary text-primary-foreground rounded-md text-sm font-semibold hover:bg-primary/90 disabled:opacity-50 transition-colors"
        >
          {isLoading ? (
            ...
            <>Join {tenant.name} <ArrowRight className="h-4 w-4" /></>
          )}
        </button>
      </form>
