    ...
    <div className="animate-in">
      ...
      <div className="relative group mb-6">
        <button
          ...
          disabled={!isGoogleOAuthConfigured || busy}
          title={!isGoogleOAuthConfigured ? 'OAuth setup required — add NEXT_PUBLIC_GOOGLE_CLIENT_ID to enable' : undefined}
          className={cn(
            'w-full flex items-center justify-center gap-3 h-10 border border-input rounded-md text-sm font-medium text-foreground bg-background transition-colors',
