...
const features = [
    {
        ...
        description: 'Personalized learning with state-of-the-art AI that adapts to each student.',
    },
    {
        icon: Shield,
        title: 'Enterprise Security',
        description: 'SOC 2 compliant with end-to-end encryption and multi-tenant isolation.',
    },
    {
        icon: BarChart3,
        title: 'Deep Analytics',
        description: 'Real-time insights into student performance, engagement, and outcomes.',
    },
];
        ...
        <div className="relative z-10 flex flex-col justify-between p-12 w-full">
          ...
          <div>
            ...
            <div className="space-y-5">
              {features.map(({ icon: Icon, title, description }) => (<div key={title} className="flex items-start gap-4">
