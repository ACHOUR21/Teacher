  ...
  return (
    <div className="animate-in">
        ...
        <div className="mb-4">
          ...
          <div className="relative">
            ...
            <input
              type="text"
              value={schoolCode}
              onChange={(e) => { setSchoolCode(e.target.value); setError(''); }}
      ...
      <button
        ...
        className="w-full flex items-center justify-center gap-2 h-10 bg-primary text-primary-foreground rounded-md text-sm font-semibold hover:bg-primary/90 disabled:opacity-40 transition-colors"
      >
