      ...
      <div className="max-w-md w-full text-center space-y-6 bg-white rounded-2xl border border-gray-200 p-8 shadow-sm">
        ...
        <div>
          ...
          <p className="text-gray-500 mt-2 text-sm leading-relaxed">
            {courseLoading ? (<span className="flex items-center justify-center gap-1 text-gray-400">
          ...
          {sessionId && (<p className="text-xs text-gray-400 mt-2 font-mono">Ref: {sessionId.slice(-12)}</p>)}
        </div>
