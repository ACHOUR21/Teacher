...
function getSubjectColor(subject, topic) {
...
function DeckSkeleton() {
    return (<div className="bg-card border border-border rounded-xl overflow-hidden animate-pulse">
...
export default function FlashcardsPage() {
    ...
    const deleteMutation = useMutation({
        mutationFn: (deckId) => api.delete(`/flashcards/decks/${deckId}`),
    ...
    return (<div className="space-y-6">
      ...
      {isLoading ? (<div className="grid gap-4 sm:grid-cols-2 lg:grid-cols-3">
        ...
        </div>) : decks.length === 0 ? (<div className="flex flex-col items-center justify-center py-20 border-2 border-dashed border-border rounded-2xl text-center">
          ...
          {decks.map(deck => {
                ...
                return (<div key={deck.id} className="bg-card border border-border rounded-xl overflow-hidden flex flex-col hover:shadow-md transition-shadow">
                {/* Color accent strip */}
                ...
                <div className="p-5 flex flex-col gap-3 flex-1">
                  <div>
                    ...
                    {(deck.subject || deck.topic) && (<p className="text-xs text-muted-foreground mt-0.5">
                  ...
                  <div className="flex gap-2 mt-auto pt-3 border-t border-border">
                    ...
                    }} disabled={deleteMutation.isPending} className="p-1.5 text-muted-foreground hover:text-destructive transition-colors rounded-md hover:bg-destructive/10 disabled:opacity-50" title="Delete deck">
