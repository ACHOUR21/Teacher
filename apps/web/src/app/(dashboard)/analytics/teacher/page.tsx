...
type SortKey = 'title' | 'students' | 'completionRate' | 'avgScore' | 'revenue';
      ...
      <Card>
        ...
        <CardContent>
          ...
          {!trendLoading && (!trend || trend.length === 0) && (
            <p className="text-sm text-gray-400 text-center py-8">No enrollment activity in the last 30 days</p>
          )}
        </CardContent>
      </Card>
        ...
        <CardContent>
          {studentsLoading ? (
            ...
            <div className="space-y-3">
              ...
              {!topStudents?.length && (
                <p className="text-sm text-gray-400 text-center py-4">No student data yet</p>
              )}
            </div>
          )}
        </CardContent>
