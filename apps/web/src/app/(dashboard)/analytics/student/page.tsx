        ...
        <Card>
          ...
          <CardContent>
            {perfLoading ? (
              ...
              <p className="text-sm text-gray-400 text-center py-16">No subject data yet</p>
            ) : (
          ...
          {activityLoading ? (
            ...
            <>
                ...
                <div className="flex flex-wrap gap-1" style={{ maxWidth: '100%' }}>
                  {dateGrid.map((date) => {
                    ...
                    if (count > 0) {
                      ...
                      else if (intensity < 0.75) bg = 'bg-green-500';
                    ...
                    return (
                      <div
                        ...
                        className={`w-4 h-4 rounded-sm ${bg} flex-shrink-0 cursor-default`}
                      />
                    );
                  })}
                </div>
              ...
              <div className="flex items-center gap-2 mt-3 text-xs text-gray-500">
                <span>Less</span>
                {['bg-gray-100', 'bg-green-200', 'bg-green-400', 'bg-green-500', 'bg-green-700'].map((cls, i) => (
          ...
          {activityLoading ? (
            ...
            <div className="space-y-3">
              {recentDays.map((date) => {
                const count = activityMap[date] ?? 0;
                return (
                  <div key={date} className="flex items-center gap-4 p-3 bg-gray-50 rounded-lg">
