...
export function CourseCard({ course }) {
    ...
    return (<Link href={`/courses/${course.id}`} className="group">
      <div className="bg-white rounded-xl border border-gray-200 overflow-hidden hover:shadow-md hover:border-blue-200 transition-all duration-200">
        ...
        <div className="relative h-40 bg-gradient-to-br from-blue-500 to-purple-600">
          ...
          {course.price === 0 && (<div className="absolute top-3 right-3">
        ...
        <div className="p-4">
          ...
          {course.teacher && (<p className="text-xs text-gray-500 mt-2">
