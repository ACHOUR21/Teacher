...
import type { AIModuleType } from '@eduai/shared';
...
export interface PromptContext {
  ...
  language?: string;
  /** The student's first name, for personalisation. */
  studentName?: string;
  /** Subject / topic the session is focused on. */
  subject?: string;
  /** Academic level: 'elementary' | 'middle' | 'high_school' | 'undergraduate' | 'postgraduate' | 'professional'. */
  level?: string;
  /** ISO 8601 date string of the session. */
  date?: string;
  /** Tenant / school name for white-label deployments. */
  institutionName?: string;
  /** Any additional freeform context. */
  extra?: string;
}

function respondInLanguage(language = 'en'): string {
...
export function aiTutorSystemPrompt(ctx: PromptContext = {}): string {
...
export function aiHomeworkAssistantSystemPrompt(ctx: PromptContext = {}): string {
...
export function aiExamGeneratorSystemPrompt(ctx: PromptContext = {}): string {
...
export function aiLessonGeneratorSystemPrompt(ctx: PromptContext = {}): string {
...
export function aiCurriculumGeneratorSystemPrompt(ctx: PromptContext = {}): string {
...
export function aiFlashcardsSystemPrompt(ctx: PromptContext = {}): string {
...
export function aiMindMapSystemPrompt(ctx: PromptContext = {}): string {
...
export function aiResearchAssistantSystemPrompt(ctx: PromptContext = {}): string {
...
export function aiTranslatorSystemPrompt(ctx: PromptContext = {}): string {
...
export function aiSpeechToTextSystemPrompt(ctx: PromptContext = {}): string {
...
export function aiTextToSpeechSystemPrompt(ctx: PromptContext = {}): string {
...
export function aiRecommendationSystemPrompt(ctx: PromptContext = {}): string {
...
export function aiCareerAdvisorSystemPrompt(ctx: PromptContext = {}): string {
...
export function aiPerformancePredictionSystemPrompt(ctx: PromptContext = {}): string {
...
export function aiDropoutPredictionSystemPrompt(ctx: PromptContext = {}): string {
...
export function aiContentModerationSystemPrompt(ctx: PromptContext = {}): string {
...
export function aiPlagiarismDetectionSystemPrompt(ctx: PromptContext = {}): string {
 ...
 */
export function getSystemPrompt(module: AIModuleType, ctx: PromptContext = {}): string {
  const registry: Record<AIModuleType, (ctx: PromptContext) => string> = {
