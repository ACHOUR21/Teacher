...
export interface ToastProps extends VariantProps<typeof toastVariants> {
  ...
  /** Optional supporting text shown below the message. */
  description?: React.ReactNode;
  /**
   * Auto-dismiss duration in milliseconds.
   * Pass `0` to disable auto-dismiss. Defaults to 5000.
   */
  duration?: number;
  /** Called when the toast is dismissed (either by the user or auto-dismiss). */
  onDismiss?: () => void;
  /** Additional class names applied to the toast root. */
  className?: string;
...
export interface ToastContainerProps {
  ...
  position?:
    ...
    | 'bottom-center'
    | 'bottom-right';
  /** Additional class names on the viewport wrapper. */
  className?: string;
  ...
  switch (type) {
    case 'success':
      return (
        <svg xmlns="http://www.w3.org/2000/svg" width="18" height="18" viewBox="0 0 24 24"
          ...
          aria-hidden="true" className="text-green-600">
    ...
    case 'error':
      return (
        <svg xmlns="http://www.w3.org/2000/svg" width="18" height="18" viewBox="0 0 24 24"
          fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round"
          aria-hidden="true" className="text-red-600">
    ...
    case 'warning':
      return (
        <svg xmlns="http://www.w3.org/2000/svg" width="18" height="18" viewBox="0 0 24 24"
          fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round"
          aria-hidden="true" className="text-amber-600">
    ...
    default:
      return (
        <svg xmlns="http://www.w3.org/2000/svg" width="18" height="18" viewBox="0 0 24 24"
          fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round"
          aria-hidden="true" className="text-blue-600">
          <circle cx="12" cy="12" r="10" />
          <path d="M12 16v-4" />
          <path d="M12 8h.01" />
        </svg>
